...
def display_v2_result_panel(run_dir: str | Path) -> None:
    """在 Streamlit 页面中展示 V2/V2.1 完整运行结果。"""
    import streamlit as st

    run_dir = Path(run_dir)
    st.subheader("V2.1 运行结果总览")
